...
var top250 = {
    init: function init() {
        this.$tabs = (0, _jquery2.default)('footer>div');
        this.$panels = (0, _jquery2.default)('main>section');
        this.index = 0;
    ...
    start: function start() {
        ...
        _jquery2.default.ajax({
            ...
            if (_this.index >= ret.total - 200) {
                _this.end = true;
                (0, _jquery2.default)('.top-ct .end').show();
            }
            common.render(ret, (0, _jquery2.default)('.top'));
        }).fail(function (err) {
            console.log('请求失败', err);
        }).always(function () {
            _this.dataArrived = false;
    ...
    scroll: function scroll() {
        ...
        (0, _jquery2.default)('main').scroll(function () {
            if (_this2.end) {
                return;
            }
            if (_this2.clock) {
            ...
            _this2.clock = setTimeout(function () {
                if ((0, _jquery2.default)('main').scrollTop() + (0, _jquery2.default)('main').height() >= (0, _jquery2.default)('.top').height() - 30) {
                    _this2.start();
                }
            }, 300);
        });
    ...
    init: function init() {
        ...
        this.clock;
        this.end = false;
        this.searchVal = (0, _jquery2.default)('.search-ct input').val();
    ...
    start: function start(val) {
        ...
        _jquery2.default.ajax({
            ...
            console.log('请求成功');
            console.log(ret);
            common.render(ret, (0, _jquery2.default)('.search-ct .content'));
        }).fail(function (err) {
            console.log('请求失败', err);
        }).always(function () {
            _this4.dataArrived = false;
            (0, _jquery2.default)('div.loading').hide();
        });
    }
};
...
var common = {
    render: function render(data, $list) {
        data.subjects.forEach(function (movie) {
            ...
            var $node = (0, _jquery2.default)(tpl);
...
top250.init();
northUS.init();
(0, _jquery2.default)('.search-ct button').on('click', search.init.bind(search));
